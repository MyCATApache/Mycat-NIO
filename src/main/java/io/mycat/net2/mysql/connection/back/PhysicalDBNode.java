...
public class PhysicalDBNode {
    ...
    // * @throws Exception
    // */
    // public void getConnectionFromSameSource(String schema, boolean
    // autocommit, Connection exitsCon,
    // ResponseHandler handler, Object attachment) throws Exception {
    //
    // PhysicalDatasource ds = this.dbPool.findDatasouce(exitsCon);
    // if (ds == null) {
    // throw new RuntimeException("can't find exits connection,maybe fininshed "
    // + exitsCon);
    // } else {
    ...
    public BackendConnection getConnection(String schema, boolean autoCommit, // RouteResultsetNode
            // rrs,
        ...
        if (dbPool.isInitSuccess()) {
            ...
            // this.database);
            // } else {
            con = dbPool.getSource().getConnection(schema, autoCommit, // handler,
                    attachment);
            // }
        } else {
